...
var createNewTaskElement=function(taskString){
    ...
    label.className='todo__task_label';

    //Each elements, needs appending
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.className="todo__task_input";
    ...
    deleteButtonImg.className = 'delete_icon'
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.todo__task_input');
    var label=listItem.querySelector(".todo__task_label");
